...
public abstract class EventStore {
    ...
    protected EventStore(EventSerializer eventSerializer, EventInitiatorResolver initiatorResolver) {
    ...
    public abstract List<StoredEvent> allEventsAfter(Long eventId);
